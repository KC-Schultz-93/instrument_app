...
from Services.DAQModels import EventSummary, PeakRecord, WaveformRecord
...
class EventDetector:
    ...
    def classify(
        ...
        # --- Rule 6: no peaks found — classify as empty regardless of raw max ---
    ...
    # SignalExtractor — these are tiny and duplication is acceptable)
    # ------------------------------------------------------------------
